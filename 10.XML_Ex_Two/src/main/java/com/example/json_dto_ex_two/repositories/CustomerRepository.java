...
*/
  ...
  /*  @Query("select new com.example.json_dto_ex_two.entities.dtoToQueries.CustomerFiveDTO(" +
   ...
   /* @Query("select new com.example.json_dto_ex_two.entities.dtoToQueries.CustomersForFifthQuery(" +
            "c.name,c.boughtCars.size) from Customer c where c.boughtCars.size>=1")
    List<CustomersForFifthQuery> getAllCustomersWithTheirCars();
*/
}
